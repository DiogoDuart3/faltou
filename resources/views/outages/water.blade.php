        ...
        <div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]" data-outage-page data-outage-type="water">
            ...
            <div class="space-y-6">
                <div class="card">
                    ...
                    <p class="mt-2 text-xs text-ink/60">Mostra relatos de falta de água nas últimas 24 horas.</p>
                    <div class="mt-4 map map--lg" data-report-map data-map-scope="water"></div>
