...
@section('content')
    <section class="mx-auto w-full max-w-6xl px-6 pb-16 pt-12">
        <div class="grid gap-8 lg:grid-cols-[1.1fr_0.9fr]" data-outage-page data-outage-type="power">
            <div>
                <div class="pill pill-ember">Falta de eletricidade</div>
                <h1 class="mt-4 text-4xl font-semibold">Partilhe uma falha de luz agora</h1>
                ...
                <div class="card mt-8 space-y-6">
                    ...
                    <form class="space-y-4" data-report-form>
                        <label class="field">
                            ...
                            <textarea rows="3" data-note placeholder="Ex: Rua sem luz desde as 14h."></textarea>
                        </label>
                        <label class="field">
                            <span>Impacto</span>
                            <select data-impact>
                                ...
                                <option value="rua">Iluminação pública</option>
                ...
                <div class="card" data-comments>
                    ...
                    <form class="mt-4 space-y-3" data-comment-form>
                        <label class="field">
                            ...
                            <textarea rows="2" data-comment-text placeholder="Ex: energia voltou às 16h."></textarea>
                        </label>
